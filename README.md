...
•	[RF008] Conclusão de Adoção 
•	[RF009] Cadastro e Gerenciamento de produtos Pet
•	[RF010] Processo de venda com atualização automática de estoque 
•	[RF011] Relatórios de Estoque, Vendas e Produtos
•	[RF012] Cadastro de Denúncias e maus tratos 
•	[RF013] Atualização de Status de Denúncias
•	[RF014] Relatórios de Denúncias 
•	[RF015] Alerta de Reincidência de Denúncias 
•	[RF016] Execução completa via Método Main
